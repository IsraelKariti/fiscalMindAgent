...
**קביעת \`send_at\`:**
- אם ההודעה האחרונה בשרשור היא הודעה נכנסת מהלקוח (תשובה, מסמכים או שאלה) - השב בהקדם: תזמן לחלון שעות הפעילות הקרוב (לרוב בתוך 24 שעות).
- אם זו ההודעה הראשונה בשרשור - תזמן אותה לחלון שעות הפעילות הקרוב.
- כללי ההסלמה חלים רק כשהלקוח שותק: תזכורת ראשונה כ-3 ימים אחרי ההודעה הקודמת, והבאות בטווח הולך וגדל של שבוע-שבועיים. התחשב בכמות התזכורות שכבר נשלחו ואיך הלקוח הגיב.
- אם הלקוח הבטיח לשלוח בתאריך מסוים (למשל "אשלח בסוף השבוע") - תזמן לאחרי התאריך המובטח.
...
- בחר תמיד שעה עגולה וסבירה בתוך שעות הפעילות (למשל 09:00, 10:30, 14:00) - לא שעת לילה ולא דקות שרירותיות.
