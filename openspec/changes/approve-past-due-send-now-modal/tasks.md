...
- [x] 1.2 Log in as a plain accountant (no impersonation) and open the same client; verify the timeline shows no awaiting-approval badge and no approve control.
...
- [x] 5.2 Walk the four spec scenarios in the browser (past-due while page open, draft already parked, cancel, confirm) and the accountant-visibility scenario; all behave as the spec says.
