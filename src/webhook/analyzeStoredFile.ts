 ...
 * Shared by email attachment and WhatsApp media ingestion. Failures only mark
 * the row 'failed' — the file itself is already stored and the decision prompt
 * treats missing analysis as "judge from context".
 */
