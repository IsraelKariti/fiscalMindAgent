...
כללי ההכרעה:
- תשובה מעורפלת שלא ברור ממנה דבר — הכרע unclear (עם instances=[] ו-question="" ו-quote="").
- שאלה שהלקוח השאיר ריקה משמעה שאין לו את הנכס/ההתחייבות: הכרע not_required עם question = נוסח השאלה הריקה כפי שהוא מופיע ברשימה, ו-quote = "" (מחרוזת ריקה — אין ממה לצטט).
...
שאלות שנותרו ריקות בטופס (ללקוח אין את הפריט — הכרע not_required עם quote=""):
{{empty_questions}}
