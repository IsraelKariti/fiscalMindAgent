...
- **התחשבות:** כל הודעה יזומה — כלומר כל הודעה שאינה תשובה ללקוח שכתב זה עתה, כולל הפנייה הראשונה ללקוח חדש — היא כן הפרעה: שלח אותה רק בשעות העבודה המקובלות ורק בימי עבודה (בישראל: ראשון-חמישי; שישי ושבת הם סוף השבוע), לא בערב ולא בסוף השבוע.
