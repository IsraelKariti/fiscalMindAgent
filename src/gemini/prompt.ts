...
מגבלות קשיחות (תמיד): לעולם לא בין 22:00 ל-07:30 בזמן המקומי של רואה החשבון; בחר שעה עגולה וסבירה (למשל 09:00, 14:30) ולא דקות שרירותיות; המועד חייב להיות מאוחר מהשעה המקומית הנוכחית המצוינת למטה.
