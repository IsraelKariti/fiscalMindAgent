...
const he = {
  ...
  mwNoPhoneColumn: 'ללא',
  mwNoBoards: 'לא נמצאו בורדים עם עמודת אימייל. הוסיפו עמודת אימייל לבורד עם הלקוחות ונסו שוב.',
...
const en: Messages = {
  ...
  mwNoBoards: 'No boards with an email column were found. Add an email column to the board holding your clients and try again.',
...
const ru: Messages = {
  ...
  mwNoPhoneColumn: 'Нет',
  mwNoBoards: 'Доски со столбцом email не найдены. Добавьте столбец email на доску с клиентами и попробуйте снова.',
