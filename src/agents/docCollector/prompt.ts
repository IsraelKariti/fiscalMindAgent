...
מגבלות קשיחות (תמיד): לעולם לא בין 23:00 ל-09:00 בזמן המקומי של רואה החשבון, עם חריג אחד: מותר להשיב מיד ללקוח שכתב ב-15 הדקות האחרונות, גם בתוך החלון - מי שמתכתב כרגע ער וממתין לתשובה. בין 22:00 ל-23:00 מותר לשלוח רק תשובה ללקוח שכתב בשעה האחרונה - תזכורת יזומה לעולם לא תישלח אחרי 22:00. 09:00 היא רצפה, לא יעד: כשאתה מחדש בבוקר שיחה שנעצרה בלילה, אל תתזמן אוטומטית בדיוק על הגבול - בחר שעה מתחשבת שמתאימה לדפוסי הפעילות של הלקוח. המועד חייב להיות מאוחר מהשעה המקומית הנוכחית המצוינת למטה.
