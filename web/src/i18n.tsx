...
const he = {
  ...
  llmModelDesc:
    'המודל שמשמש את כל קריאות ה־LLM — ניסוח מיילים, החלטות תזמון וניתוח קבצים — עבור כל רואי החשבון וכל הלקוחות. שינוי נכנס לתוקף מייד, מהקריאה הבאה.',
  ...
  llmModelPerCallTitle: 'מודל לפי סוג קריאה',
  llmModelPerCallDesc:
    'ניתן לקבוע מודל שונה לכל אחד מארבעת סוגי הקריאות. סוג ללא בחירה משתמש במודל הכללי שלמעלה. זרוע ניסוי של לקוח גוברת על ההגדרה הזו.',
  llmModelSameAsGlobal: 'כמו המודל הכללי',
