...
const he = {
  ...
  agentAnnualReportName: 'עוזר דוח שנתי',
  agentAnnualReportDesc:
    'מראיין את הלקוח באימייל ובוואטסאפ, קובע בעצמו אילו מסמכים נדרשים לדוח השנתי האישי (טופס 1301/135) ואוסף אותם.',
  addClientLeadAnnual:
    'אין צורך להגדיר רשימת מסמכים — הסוכן יראיין את הלקוח, יקבע בעצמו אילו מסמכים נדרשים לדוח השנתי, והרשימה תיבנה ותתמלא בלשונית המסמכים תוך כדי השיחה.',
  annualDocsTitle: 'מסמכים שנקבעו בראיון',
  annualDocsEmpty: 'הסוכן קובע את רשימת המסמכים במהלך הראיון עם הלקוח — הרשימה תתמלא כאן.',
