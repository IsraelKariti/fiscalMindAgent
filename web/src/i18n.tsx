...
const he = {
  ...
  householdLabel: 'משק הבית',
  maritalMarried: 'נשוי/אה',
  maritalNotMarried: 'לא נשוי/אה',
  maritalUnknown: 'מצב משפחתי לא ידוע',
  spouseLabel: 'בן/בת זוג',
  spouseNameUnknown: 'שם לא ידוע',
  spouseIdLabel: 'ת"ז',
  spouseSourceQuestionnaire: 'מהשאלון',
  spouseSourceCrm: 'מכרטיס ה-CRM',
  spouseSourceDocument: 'ממסמך שנשלח',
  ...
  stepActionLabels: {
    ...
    'client.spouse_inferred': 'Spouse Adopted From Document',
    'client.spouse_updated': 'Spouse Updated From monday',
  ...
  stepFieldLabels: {
    ...
    subject_matched: 'המסמך זוהה כשייך ל־(client = הלקוח, spouse = בן/בת הזוג)',
    documents: 'מסמכים',
    count: 'מספר שינויים',
    action: 'פעולה',
    emailId: 'מזהה טיוטה',
  ...
  gateCheckLabels: {
    ...
    id_matches_client: 'תעודת הזהות במסמך היא של הלקוח או של בן/בת הזוג הרשומים',
    spouse_adopted: 'בן/בת הזוג נרשמו במערכת מהמסמך הזה',
