...
const en: Messages = {
  ...
  csSettingsTitle: 'monday connection',
  csMondayAccount: 'monday account',
  csGroupSources: 'Knowledge sources',
  ...
  csNameColumn: 'Name column',
  csNameColumnDefault: 'Item name (default)',
  csChooseDocs: 'Choose workdocs',
  csChooseBoards: 'Choose boards',
  csPickerSearch: 'Search…',
  csPickerNoMatches: 'No matches.',
  csRemove: 'Remove',
  csSaved: 'Saved',
  ...
  adminWaPoolButton: 'Select from pool',
  adminWaPoolTitle: 'Select a number from the pool',
  adminWaPoolDesc: 'Owned Twilio numbers not currently assigned to any agent. Selecting one assigns it to this agent.',
  adminWaPoolSelect: 'Select',
  adminWaDetachAction: 'Detach from agent',
  adminWaDetachDesc:
    'Unassign the number from this agent only — it stays on the Twilio account (billing continues) and can be reassigned.',
  adminWaAssignLead: 'This agent has no WhatsApp number. Choose how to assign one:',
  adminWaOptionPoolDesc: (n: number) => `${n} owned numbers are waiting unassigned.`,
  adminWaOptionPoolEmpty: 'The pool is currently empty.',
  adminWaOptionBuyDesc: 'Buys a new number from Twilio (~$1.15/month) — registration and assignment are automatic.',
  adminWaOptionManualTitle: 'Enter manually',
  adminWaOptionManualDesc: 'A Twilio number the account already owns, in international format.',
  adminAgentNotInstantiated:
    'This agent is not enabled on this account yet. Enabling it creates it and lets you assign a WhatsApp number.',
  ...
  settingsGroupChannels: 'Agent channels',
  ...
  dueDateLabel: 'Collection due date (optional)',
  ...
  adminNoMatches: 'No matching accounts.',
  adminManageAgent: 'Manage',
  adminBackToList: 'Back to the accountants list',
  adminAccountantNotFound: 'This accountant was not found — they may have been removed.',
  adminLlmSpendLabel: 'LLM spend',
  adminLlmSpendNone: 'No usage yet',
  adminDangerZone: 'Danger zone',
  adminRevokeDesc:
    'Revoking access locks the accountant out immediately. Their data is kept, and access can be re-activated at any time.',
  ...
  mwDueDateColumnLabel: 'Due-date column',
  mwNoDueDateColumn: 'None',
  mwDueDateColumnHint: 'The deadline for collecting the documents; the agent sends reminders more often as it approaches.',
...
const ru: Messages = {
  ...
  csSettingsTitle: 'Подключение monday',
  csMondayAccount: 'Аккаунт monday',
  csGroupSources: 'Источники знаний',
  ...
  csNameColumn: 'Колонка имени',
  csNameColumnDefault: 'Имя элемента (по умолчанию)',
  csChooseDocs: 'Выбрать документы',
  csChooseBoards: 'Выбрать доски',
  csPickerSearch: 'Поиск…',
  csPickerNoMatches: 'Ничего не найдено.',
  csRemove: 'Убрать',
  csSaved: 'Сохранено',
  ...
  adminWaPoolButton: 'Выбрать из пула',
  adminWaPoolTitle: 'Выбор номера из пула',
  adminWaPoolDesc: 'Номера Twilio на аккаунте, не назначенные сейчас ни одному агенту. Выбор номера назначит его этому агенту.',
  adminWaPoolSelect: 'Выбрать',
  adminWaDetachAction: 'Отвязать от агента',
  adminWaDetachDesc:
    'Только отвязать номер от этого агента — он остаётся на аккаунте Twilio (оплата продолжается) и может быть назначен снова.',
  adminWaAssignLead: 'У этого агента нет номера WhatsApp. Выберите, как назначить его:',
  adminWaOptionPoolDesc: (n: number) =>
    `${n} ${ruPlural(n, 'номер аккаунта ждёт', 'номера аккаунта ждут', 'номеров аккаунта ждут')} без назначения.`,
  adminWaOptionPoolEmpty: 'Пул сейчас пуст.',
  adminWaOptionBuyDesc: 'Покупка нового номера у Twilio (~$1.15/мес) — регистрация и назначение автоматические.',
  adminWaOptionManualTitle: 'Ввести вручную',
  adminWaOptionManualDesc: 'Номер Twilio, уже принадлежащий аккаунту, в международном формате.',
  adminAgentNotInstantiated:
    'Этот агент ещё не включён в этом аккаунте. Включение создаст его и позволит назначить номер WhatsApp.',
  ...
  settingsGroupChannels: 'Каналы агента',
  ...
  dueDateLabel: 'Срок сбора (необязательно)',
  ...
  adminSearchPlaceholder: 'Поиск по имени или адресу…',
  adminStatusLabel: 'Статус',
  adminNoMatches: 'Совпадений не найдено.',
  adminManageAgent: 'Управление',
  adminBackToList: 'К списку бухгалтеров',
  adminAccountantNotFound: 'Этот бухгалтер не найден — возможно, он был удалён.',
  adminLlmSpendLabel: 'Расходы на LLM',
  adminLlmSpendNone: 'Использования пока нет',
  adminDangerZone: 'Опасные действия',
  adminRevokeDesc:
    'Отзыв доступа немедленно закрывает бухгалтеру вход. Данные сохраняются, и доступ можно активировать снова в любой момент.',
  justAMoment: 'Секунду…',
  ...
  mwDueDateColumnLabel: 'Столбец со сроком',
  mwNoDueDateColumn: 'Нет',
  mwDueDateColumnHint: 'Срок сбора документов; по мере его приближения агент напоминает чаще.',
