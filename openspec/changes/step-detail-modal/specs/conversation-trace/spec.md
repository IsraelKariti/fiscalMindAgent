...
**Reason**: Every step row now opens the detail modal, whether or not it recorded a checks list.
**Migration**: None. Rows without checks open the same modal with the detail section and no checks section.
