...
const he = {
  ...
  agentWhatsAppNone: 'עדיין לא הוקצה מספר וואטסאפ לחשבון שלך.',
  copied: 'הועתק!',
...
const en: Messages = {
  ...
  agentWhatsAppNone: 'No WhatsApp number has been assigned to your account yet.',
  copied: 'Copied!',
...
const ru: Messages = {
  ...
  agentWhatsAppNone: 'Вашему аккаунту ещё не назначен номер WhatsApp.',
  copied: 'Скопировано!',
